...
insert into ETAPE values (23, 4, 'COUPEZ LES TOMATES ET LA MOZZARELLA EN TRANCHE');
insert into ETAPE values (24, 4, 'ALIGNEZ UNE TRANCHE DE MOZZARELLA PUIS UNE TRANCHE DE TOMATE ET AINSI DE SUITE');
insert into ETAPE values (25, 4, 'SOUPOUDREZ DE PERSIL ET D HUILE');
insert into ETAPE values (26, 5, 'METTRE A CUIRE LES PATES');
insert into ETAPE values (27, 5, 'EMINCEZ LES OIGNONS ET LES FAIRE REVENIR A LA POELE');
insert into ETAPE values (28, 5, 'DES QUE LES OIGNONS SONT DORES, AJOUTEZ LES LARDONS');
insert into ETAPE values (29, 5, 'DANS UN SALADIER, MELANGEZ LA CREME FRAICHE, LES OEUFS ET LE SEL');
insert into ETAPE values (30, 5, 'DES QUE LES LARDONS SONT DORES, AJOUTEZ LES A LA CREME');
insert into ETAPE values (31, 5, 'DES QUE LES PATES SONT CUITES, EGOUTEZ LES ET INCORPOREZ LA CREME');
insert into ETAPE values (32, 5, 'SERVEZ CHAUD');
